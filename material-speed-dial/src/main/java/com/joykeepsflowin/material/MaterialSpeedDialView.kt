...
import com.joykeepsflowin.material.extensions.dpToDimensionPixelSize
import com.joykeepsflowin.material.extensions.getColorByAttr
import com.joykeepsflowin.material.extensions.getResourceIdByAttr
import com.joykeepsflowin.material.extensions.isMaterial3Theme
import com.joykeepsflowin.material.extensions.makeupWithAlpha
import com.joykeepsflowin.material.extensions.shortAnimTime
import com.leinardi.android.speeddial.FabWithLabelView
import com.leinardi.android.speeddial.SpeedDialActionItem
import com.leinardi.android.speeddial.SpeedDialView

class MaterialSpeedDialView : SpeedDialView {
    ...
    override fun onAttachedToWindow() {
        ...
        if (overlayLayout != null) {
            ...
            val overlayColor = surfaceColor.makeupWithAlpha(0.87f)
    ...
    private class State(val superState: Parcelable?, val isOpen: Boolean) : Parcelable {
        ...
        companion object CREATOR : Parcelable.Creator<State> {
            override fun createFromParcel(parcel: Parcel): State {
                val superState = parcel.readParcelable<Parcelable>(State::class.java.classLoader)
                val isOpen = parcel.readByte() != 0.toByte()
                return State(superState, isOpen)
            }
